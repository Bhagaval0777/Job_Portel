...
class JobSeekerProfile(models.Model):
    jobseeker_profile_id = models.AutoField(primary_key=True)  # ✅ Custom PK
...
class Skill(models.Model):
    skill_id = models.AutoField(primary_key=True)  # ✅ Custom PK
...
class PreferredLocation(models.Model):
    location_id = models.AutoField(primary_key=True)  # ✅ Custom PK
...
class Education(models.Model):
    education_id = models.AutoField(primary_key=True)  # ✅ Custom PK
...
class Experience(models.Model):
    experience_id = models.AutoField(primary_key=True)  # ✅ Custom PK
